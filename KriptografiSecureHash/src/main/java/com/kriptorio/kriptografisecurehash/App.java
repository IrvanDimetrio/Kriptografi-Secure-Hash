package com.kriptorio.kriptografisecurehash;
...
/**
 * Aplikasi Secure Hash dengan algoritma hash Dapat dirubah algoritma hash pada
 * argumen di object SecureHash misal: SHA512, SHA256, MD5, dlsb
 */
public class App {
